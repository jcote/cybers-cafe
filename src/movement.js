...
Movement.prototype.isBodyFocused = function () {
    var bodyFocused = document.activeElement == document.getElementsByTagName("BODY")[0];
    var canvasFocused = document.activeElement == document.getElementById("application-canvas");
    return bodyFocused || canvasFocused;
}
