...
0===a[14]&&1===a[15]},mul2:function(a,b){var c,d,f,g,h,e,l,k,n,r,m,t,q,u,y,x,v,w,z,A;x=a.data;var B=b.data,D=this.data;c=x[0];d=x[1];f=x[2];g=x[3];h=x[4];e=x[5];l=x[6];k=x[7];n=x[8];r=x[9];m=x[10];t=x[11];q=x[12];u=x[13];y=x[14];x=x[15];v=B[0];w=B[1];z=B[2];A=B[3];D[0]=c*v+h*w+n*z+q*A;D[1]=d*v+e*w+r*z+u*A;D[2]=f*v+l*w+m*z+y*A;D[3]=g*v+k*w+t*z+x*A;v=B[4];w=B[5];z=B[6];A=B[7];D[4]=c*v+h*w+n*z+q*A;D[5]=d*v+e*w+r*z+u*A;D[6]=f*v+l*w+m*z+y*A;D[7]=g*v+k*w+t*z+x*A;v=B[8];w=B[9];z=B[10];A=B[11];D[8]=c*v+h*
w+n*z+q*A;D[9]=d*v+e*w+r*z+u*A;D[10]=f*v+l*w+m*z+y*A;D[11]=g*v+k*w+t*z+x*A;v=B[12];w=B[13];z=B[14];A=B[15];D[12]=c*v+h*w+n*z+q*A;D[13]=d*v+e*w+r*z+u*A;D[14]=f*v+l*w+m*z+y*A;D[15]=g*v+k*w+t*z+x*A;return this},mul:function(a){return this.mul2(this,a)},transformPoint:function(a,b){var c=this.data,d=a.data;b=void 0===b?new pc.Vec3:b;return b.set(d[0]*c[0]+d[1]*c[4]+d[2]*c[8]+c[12],d[0]*c[1]+d[1]*c[5]+d[2]*c[9]+c[13],d[0]*c[2]+d[1]*c[6]+d[2]*c[10]+c[14])},transformVector:function(a,b){var c=this.data,
...
g+Math.max(b,8)*Math.max(d,8)/2:g+Math.floor((b+4-1)/4)*Math.floor((d+4-1)/4)*(a._format===pc.PIXELFORMAT_DXT1?8:16):g+b*d*m[a._format],b=Math.max(.5*b,1),d=Math.max(.5*d,1);a._cubemap&&(g*=6);a._gpuSize=g;this._vram.tex+=a._gpuSize}},setTexture:function(a,b){var c=this.gl;a._glTextureId||this.initializeTexture(a);var d=a._minFilterDirty||a._magFilterDirty||a._addressUDirty||a._addressVDirty||a._anisotropyDirty;if(this.textureUnits[b]!==a||d)this.activeTexture!==b&&(c.activeTexture(c.TEXTURE0+b),
...
t=c.scope.resolve("params"),q=new pc.Vec4,u=f.width,k=f.format,y=[[],b.filteredFixed,b.filteredRgbm,b.filteredFixedRgbm],x=0===g?[.9,.85,.7,.4,.25]:[512,128,32,8,2],v=[64,32,16,8,4],w,z,A;z=k===pc.PIXELFORMAT_R8_G8_B8;w=!1;var B;p&&(w=f._levels[0][0]instanceof HTMLImageElement);if((z||w)&&p){k=pc.PIXELFORMAT_R8_G8_B8_A8;B=new pc.gfx.Texture(c,{cubemap:!0,rgbm:n,format:k,width:u,height:u,mipmaps:!1});for(A=0;6>A;A++)w=new pc.RenderTarget(c,B,{face:A,depth:!1}),q.x=A,q.y=0,m.setValue(f),t.setValue(q.data),
l&&e(),pc.drawQuadWithShader(c,w,r),a(c,w,A);f=B}if(128<u){var D=Math.round(Math.log2(u))-Math.round(Math.log2(128));for(z=0;z<D;z++){var u=.5*f.width,J=0===g?1:Math.pow(2,Math.round(Math.log2(x[0])+2*(D-z)));B=new pc.gfx.Texture(c,{cubemap:!0,rgbm:n,format:k,width:u,height:u,mipmaps:!1});for(A=0;6>A;A++)w=new pc.RenderTarget(c,B,{face:A,depth:!1}),q.x=A,q.y=J,q.z=u,q.w=n?3:0,m.setValue(f),t.setValue(q.data),l&&e(),pc.drawQuadWithShader(c,w,r),z===D-1&&p&&a(c,w,A);f=B}}b.sourceCubemap=f;B=null;if(!n&&
b.filteredFixedRgbm)for(B=new pc.gfx.Texture(c,{cubemap:!0,rgbm:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,width:u,height:u,mipmaps:!1}),A=0;6>A;A++)w=new pc.RenderTarget(c,B,{face:A,depth:!1}),q.x=A,q.w=2,m.setValue(f),t.setValue(q.data),l&&e(),pc.drawQuadWithShader(c,w,r),a(c,w,A);u=0===g?1:2048;w=0===g?0:-1;y[w]=[];for(z=0;5>z;z++)for(r=w;r<y.length;r++)null!=y[r]&&(y[r][z]=new pc.gfx.Texture(c,{cubemap:!0,rgbm:2>r?n:!0,format:2>r?k:pc.PIXELFORMAT_R8_G8_B8_A8,fixCubemapSeams:1===r||3===r,width:v[z],
height:v[z],mipmaps:!1}));for(r=w;r<y.length;r++)if(null!=y[r])if(1<r&&n)y[r]=y[r-2];else for(z=0;5>z;z++)for(A=0;6>A;A++)w=new pc.RenderTarget(c,y[r][z],{face:A,depth:!1}),q.x=A,q.y=0>r?u:x[z],q.z=v[z],q.w=n?3:r,m.setValue(0===z?f:0===g?y[0][z-1]:y[-1][z-1]),t.setValue(q.data),l&&e(),pc.drawQuadWithShader(c,w,h),p&&a(c,w,A);b.filtered=y[0];if(p&&b.singleFilteredFixed){f=[f,b.filteredFixed[0],b.filteredFixed[1],b.filteredFixed[2],b.filteredFixed[3],b.filteredFixed[4],b.filteredFixed[5]];n=new pc.gfx.Texture(c,
{cubemap:!0,rgbm:n,fixCubemapSeams:!0,format:k,width:128,height:128,addressU:pc.ADDRESS_CLAMP_TO_EDGE,addressV:pc.ADDRESS_CLAMP_TO_EDGE});for(z=0;6>z;z++)n._levels[z]=f[z]._levels[0];n.upload();n._prefilteredMips=!0;b.singleFilteredFixed=n}if(p&&b.singleFilteredFixedRgbm&&b.filteredFixedRgbm){f=[B,b.filteredFixedRgbm[0],b.filteredFixedRgbm[1],b.filteredFixedRgbm[2],b.filteredFixedRgbm[3],b.filteredFixedRgbm[4],b.filteredFixedRgbm[5]];n=new pc.gfx.Texture(c,{cubemap:!0,rgbm:!0,fixCubemapSeams:!0,format:pc.PIXELFORMAT_R8_G8_B8_A8,
...
p.readPixels(0,0,r.width,r.height,p.RGBA,p.UNSIGNED_BYTE,m);a._levels[0][c]=m}}else{console.error("ERROR: SH: cubemap must be composed of arrays or images");return}l=[];for(p=0;p<g;p++)for(e=0;e<g;e++)l[p*g+e]=(new pc.Vec3(e/(g-1)*2-1,p/(g-1)*2-1,1)).normalize();var k=new Float32Array(27),t,q,u,y,x,v,w,z,A,B,D;for(c=n=0;6>c;c++)for(p=0;p<g;p++)for(e=0;e<g;e++){r=p*g+e;m=e;w=p;z=g;q=(2*(m+.5)/z-1)*(1-1/z);D=(2*(w+.5)/z-1)*(1-1/z);t=1/z;A=q-t;B=D-t;q+=t;D+=t;A=b(A,B)-b(A,D)-b(q,B)+b(q,D);if(0===m&&
0===w||m===z-1&&0===w||0===m&&w===z-1||m===z-1&&w===z-1)A/=3;else if(0===m||0===w||m===z-1||w===z-1)A*=.5;m=A;w=4*m/17;z=8*m/17;A=15*m/17;B=5*m/68;D=15*m/68;t=l[r];0==c?(y=t.z,x=-t.y,v=-t.x):1==c?(y=-t.z,x=-t.y,v=t.x):2==c?(y=t.x,x=t.z,v=t.y):3==c?(y=t.x,x=-t.z,v=-t.y):4==c?(y=t.x,x=-t.y,v=t.z):5==c&&(y=-t.x,x=-t.y,v=-t.z);d||(y=-y);q=a._levels[0][c][4*r+3]/255;for(t=0;3>t;t++)u=a._levels[0][c][4*r+t]/255,a.rgbm?(u*=8*q,u*=u):u=Math.pow(u,2.2),k[0+t]+=u*w,k[3+t]+=u*z*y,k[6+t]+=u*z*x,k[9+t]+=u*z*v,
k[12+t]+=u*A*y*v,k[15+t]+=u*A*v*x,k[18+t]+=u*A*x*y,k[21+t]+=u*B*(3*v*v-1),k[24+t]+=u*D*(y*y-x*x),n+=m}for(t=0;t<k.length;t++)k[t]*=4*Math.PI/n;return k}console.error("ERROR: SH: cubemap must be synced to CPU")}}}}());pc.extend(pc,function(){return{paraboloidFromCubemap:function(e,a,b,c){var d=pc.shaderChunks,d=d.createShaderFromCode(e,d.fullscreenQuadVS,(a.fixCubemapSeams?d.fixCubemapSeamsStretchPS:d.fixCubemapSeamsNonePS)+d.genParaboloidPS,"genParaboloid"),f=e.scope.resolve("source"),g=e.scope.resolve("params"),h=new pc.Vec4,p=a.width,l=a.rgbm,k=a.format,p=2*Math.max(p,8),p=new pc.gfx.Texture(e,{rgbm:l,format:k,width:2*p,height:p,mipmaps:!1}),l=new pc.RenderTarget(e,p,{depth:!1});h.x=b;h.y=c?-1:1;f.setValue(a);
...
u+"_shadowParamsVS);\n")));t=[];var y=[],x,v,w;for(c in pc._matTex2D)b=c+"Map",a[b+"VertexColor"]?(x=b+"Channel",a[x]=this._correctChannel(c,a[x])):a[b]&&(x=b+"Channel",v=b+"Transform",w=b+"Uv",a[w]=Math.min(a[w],1),a[x]=this._correctChannel(c,a[x]),w=a[w],t[w]=!0,y[w]=y[w]||a[b]&&!a[v]);a.forceUv1&&(t[1]=!0);for(b=0;2>b;b++)t[b]&&(q["vertex_texCoord"+b]=pc["SEMANTIC_TEXCOORD"+b],k+=m["uv"+b+"VS"],n+="   vec2 uv"+b+" = getUv"+b+"();\n"),y[b]&&(n+="   vUv"+b+" = uv"+b+";\n");t=[k,r,n,[]];for(c in pc._matTex2D)b=
...
m.extensionPS&&(k+=m.extensionPS+"\n");k+=a.forceFragmentPrecision?"precision "+a.forceFragmentPrecision+" float;\n\n":pc.programlib.precisionCode(e);if(a.customFragmentShader)return k+=a.customFragmentShader,{attributes:q,vshader:c,fshader:k,tag:pc.SHADERTAG_MATERIAL};r=k=k+r+m.basePS;k="";y=0;v=[];w=!1;for(b=0;b<a.lights.length;b++)if(n=a.lights[b],t=n._type,k+="uniform vec3 light"+b+"_color;\n",t===pc.LIGHTTYPE_DIRECTIONAL?k+="uniform vec3 light"+b+"_direction;\n":(k+="uniform vec3 light"+b+"_position;\n",
...
0,g.clearColor[3]=0):(g.clearColor[0]=1,g.clearColor[1]=1,g.clearColor[2]=1,g.clearColor[3]=1);g.clearDepth=1;g.clearFlags=d;g.clearStencil=null;g._node=new pc.GraphNode;c=b._shadowCamera=g;f(a,b)}else d=c.renderTarget,d.width===b._shadowResolution&&d.height===b._shadowResolution||f(a,b);return c},updateCameraFrustum:function(a){var b;if(a.vrDisplay&&a.vrDisplay.presenting){b=a.vrDisplay.combinedProj;var c=a._node.getParent();c?y.copy(c.getWorldTransform()).mul(a.vrDisplay.combinedViewInv).invert():
y.copy(a.vrDisplay.combinedView);u.copy(y).invert();this.viewInvId.setValue(u.data)}else{b=a.getProjectionMatrix();var c=a._node.getPosition(),d=a._node.getRotation();u.setTRS(c,d,pc.Vec3.ONE);this.viewInvId.setValue(u.data);y.copy(u).invert()}a.frustum.update(b,y)},setCamera:function(a,b){var c=a.vrDisplay;if(c&&c.presenting){L=c.leftProj;H=c.rightProj;var d=a._node.getParent();if(d){var f=d.getWorldTransform();w.mul2(f,c.leftViewInv);z.mul2(f,c.rightViewInv);A.copy(w).invert();B.copy(z).invert();
y.copy(d.getWorldTransform()).mul(c.combinedViewInv).invert()}else w.copy(c.leftViewInv),z.copy(c.rightViewInv),A.copy(c.leftView),B.copy(c.rightView),y.copy(c.combinedView);p(K,A);p(F,B);C.mul2(c.leftProj,A);O.mul2(c.rightProj,B);D.data[0]=w.data[12];D.data[1]=w.data[13];D.data[2]=w.data[14];J.data[0]=z.data[12];J.data[1]=z.data[13];J.data[2]=z.data[14];a.frustum.update(c.combinedProj,y)}else c=a.getProjectionMatrix(),this.projId.setValue(c.data),d=a._node.getPosition(),f=a._node.getRotation(),u.setTRS(d,
f,pc.Vec3.ONE),this.viewInvId.setValue(u.data),y.copy(u).invert(),this.viewId.setValue(y.data),p(x,y),this.viewId3.setValue(x.data),v.mul2(c,y),this.viewProjId.setValue(v.data),this.viewPosId.setValue(a._node.getPosition().data),a.frustum.update(c,y);this.nearClipId.setValue(a._nearClip);this.farClipId.setValue(a._farClip);var c=this.device,g=a.renderTarget;c.setRenderTarget(g);c.updateBegin();var f=a.getRect(),d=g?g.width:c.width,g=g?g.height:c.height,e=Math.floor(f.x*d),h=Math.floor(f.y*g),k=Math.floor(f.width*
...
I.x>S&&(S=I.x),I.y<E&&(E=I.y),I.y>B&&(B=I.y),I.z<X&&(X=I.z),I.z>k&&(k=I.z);h=G/u._shadowResolution;S=.5*(G-(S-P));P=Math.floor((P-S)/h)*h;S=.5*(G-(B-E));E=Math.floor((E-S)/h)*h;S=P+G;B=E+G;P=.5*(S+P);E=.5*(B+E);w.translateLocal(P,E,1E5);x.projection=pc.PROJECTION_ORTHOGRAPHIC;x.nearClip=0;x.farClip=2E5;x.aspectRatio=1;x.orthoHeight=.5*G}else if(y===pc.LIGHTTYPE_SPOT){if(b.frustumCulling&&(u.getBoundingSphere(W),!b.frustum.containsSphere(W)))continue;x.projection=pc.PROJECTION_PERSPECTIVE;x.nearClip=
u.attenuationEnd/1E3;x.farClip=u.attenuationEnd;x.aspectRatio=1;x.fov=2*u._outerConeAngle;this.viewPosId.setValue(w.getPosition().data);this.shadowMapLightRadiusId.setValue(u.attenuationEnd)}else if(y===pc.LIGHTTYPE_POINT){if(b.frustumCulling&&(u.getBoundingSphere(W),!b.frustum.containsSphere(W)))continue;x.projection=pc.PROJECTION_PERSPECTIVE;x.nearClip=u.attenuationEnd/1E3;x.farClip=u.attenuationEnd;x.aspectRatio=1;x.fov=90;z=6;this.viewPosId.setValue(w.getPosition().data);this.shadowMapLightRadiusId.setValue(u.attenuationEnd)}u.shadowUpdateMode===
pc.SHADOWUPDATE_THISFRAME&&(u.shadowUpdateMode=pc.SHADOWUPDATE_NONE);this._shadowMapUpdates+=z;for(G=0;G<z;G++){y===pc.LIGHTTYPE_POINT&&(0===G?w.setEulerAngles(0,90,180):1===G?w.setEulerAngles(0,-90,180):2===G?w.setEulerAngles(90,0,0):3===G?w.setEulerAngles(-90,0,0):4===G?w.setEulerAngles(0,180,180):5===G&&w.setEulerAngles(0,0,180),w.setPosition(A.getPosition()),x.renderTarget=u._shadowCubeMap[G]);this.setCamera(x,y!==pc.LIGHTTYPE_POINT);h=R.length=0;for(I=f.length;h<I;h++)k=f[h],B=!0,k.cull&&(B=
this._isVisible(x,k)),B&&R.push(k);this.updateGpuSkinMatrices(R);B=u._shadowType;S=B+(y!==pc.LIGHTTYPE_DIRECTIONAL?4:0);this.sortDrawCalls(R,this.depthSortCompare,pc.SORTKEY_DEPTH);this.prepareInstancing(a,R,pc.SORTKEY_DEPTH,pc.SHADER_SHADOW+S);if(y===pc.LIGHTTYPE_DIRECTIONAL){I=!0;for(h=0;h<R.length;h++)k=R[h],k=k.aabb,I?(Y.copy(k),I=!1):Y.add(k);h=m;k=Y.getMin();I=Y.getMax();N[0].x=N[1].x=N[2].x=N[3].x=k.x;N[1].y=N[3].y=N[7].y=N[5].y=k.y;N[2].z=N[3].z=N[6].z=N[7].z=k.z;N[4].x=N[5].x=N[6].x=N[7].x=
I.x;N[0].y=N[2].y=N[4].y=N[6].y=I.y;N[0].z=N[1].z=N[4].z=N[5].z=I.z;T=9999999999;k=-9999999999;for(v=0;8>v;++v)h.transformPoint(N[v],N[v]),I=N[v].z,I<T&&(T=I),I>k&&(k=I);h=T;h>X&&(X=h);w.setPosition(A.getPosition());w.translateLocal(P,E,k+.01);x.farClip=k-X;this.setCamera(x,!0)}y!==pc.LIGHTTYPE_POINT&&(m.setTRS(w.getPosition(),w.getRotation(),pc.Vec3.ONE).invert(),t.mul2(x.getProjectionMatrix(),m),u._shadowMatrix.mul2(l,t));a.setBlending(!1);a.setColorWrite(!0,!0,!0,!0);a.setDepthWrite(!0);a.setDepthTest(!0);
a.extDepthTexture&&a.setColorWrite(!1,!1,!1,!1);h=0;for(I=R.length;h<I;h++)k=R[h],T=k.mesh,v=k.material,this.setBaseConstants(a,v),this.setSkinning(a,k,v),v=k._shader[pc.SHADER_SHADOW+S],v||(v=this.findShadowShader(k,y,B),k._shader[pc.SHADER_SHADOW+S]=v,k._key[pc.SORTKEY_DEPTH]=g(k)),a.setShader(v),v=k.renderStyle,a.setVertexBuffer(T.vertexBuffer,0),a.setIndexBuffer(T.indexBuffer[v]),h+=this.drawInstance(a,k,T,v),this._shadowDrawCalls++}u._shadowType>pc.SHADOW_DEPTH&&(y=u._vsmBlurSize,1<y&&(x=x.renderTarget,
w=d(a,u._shadowResolution,u._shadowType,1),A=u.vsmBlurMode,z=(u._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[A][y],z||(this.blurVsmWeights[y]=c(y),z=pc.shaderChunks,(u._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShader:this.blurVsmShader)[A][y]=z=z.createShaderFromCode(this.device,z.fullscreenQuadVS,"#define SAMPLES "+y+"\n"+(u._shadowType===pc.SHADOW_VSM8?this.blurPackedVsmShaderCode:this.blurVsmShaderCode)[A],"blurVsm"+A+""+y+""+(u._shadowType===pc.SHADOW_VSM8))),
r.z=u._shadowResolution-2,r.w=r.z,this.sourceId.setValue(x.colorBuffer),n.x=1/u._shadowResolution,n.y=0,this.pixelOffsetId.setValue(n.data),A===pc.BLUR_GAUSSIAN&&this.weightId.setValue(this.blurVsmWeights[y]),pc.drawQuadWithShader(a,w,z,null,r),this.sourceId.setValue(w.colorBuffer),n.y=n.x,n.x=0,this.pixelOffsetId.setValue(n.data),pc.drawQuadWithShader(a,x,z,null,r)))}},findDepthShader:function(a){var b=a.material;return this.library.getProgram("depth",{skin:!!a.skinInstance,opacityMap:!!b.opacityMap,
...
l._staticSource):n.push(l);h=n;p=h.length;n=[]}var q,r,u,v,x,y,w,R,G,A,z,B,S;t=new pc.Vec3;var P=new pc.Vec3;new pc.BoundingBox;var E=new pc.BoundingBox,T=new pc.Mat4,D=[],J,aa,M,C=[],H=[],L=[];for(c=0;c<p;c++)if(l=h[c],l.isStatic){q=l.aabb;L.length=0;for(aa=pc.LIGHTTYPE_POINT;aa<=pc.LIGHTTYPE_SPOT;aa++)for(d=0;d<k.length;d++)m=k[d],m._type===aa&&m._enabled&&m._mask&l.mask&&m.isStatic&&(C[d]||(C[d]=new pc.BoundingBox,m._node.getWorldTransform(),m.getBoundingSphere(W),C[d].center.copy(W.center),C[d].halfExtents.x=
W.radius,C[d].halfExtents.y=W.radius,C[d].halfExtents.z=W.radius),C[d].intersects(q)&&L.push(d));if(0===L.length)n.push(l);else{q=l.mesh;aa=q.vertexBuffer;m=q.indexBuffer[l.renderStyle];r=new Uint16Array(m.lock());u=q.primitive[l.renderStyle].count/3;y=q.primitive[l.renderStyle].base;d=aa.format.elements;v=aa.format.size/4;q=new Float32Array(aa.storage);for(f=0;f<d.length;f++)d[f].name===pc.SEMANTIC_POSITION&&(x=d[f].offset/4);D.length=u;for(f=0;f<u;f++)D[f]=0;J=!1;H.length=6*u;for(f=0;f<u;f++){A=
G=R=Number.MAX_VALUE;z=-Number.MAX_VALUE;B=-Number.MAX_VALUE;S=-Number.MAX_VALUE;for(g=0;3>g;g++)d=r[3*f+g+y],d=d*v+x,e=q[d],w=q[d+1],d=q[d+2],e<R&&(R=e),w<G&&(G=w),d<A&&(A=d),e>z&&(z=e),w>B&&(B=w),d>S&&(S=d);d=6*f;H[d]=R;H[d+1]=G;H[d+2]=A;H[d+3]=z;H[d+4]=B;H[d+5]=S}for(e=0;e<L.length;e++)for(d=L[e],T.copy(l.node.worldTransform).invert(),E.setFromTransformedAabb(C[d],T),w=E.getMin().data,R=E.getMax().data,g=1<<e,f=0;f<u;f++)d=6*f,H[d]<=R[0]&&H[d+3]>=w[0]&&H[d+1]<=R[1]&&H[d+4]>=w[1]&&H[d+2]<=R[2]&&
H[d+5]>=w[2]&&(D[f]|=g,J=!0);if(J){J={};for(f=0;f<u;f++)d=3*f+y,M=D[f],J[M]||(J[M]=[]),g=J[M],g.push(r[d]),g.push(r[d+1]),g.push(r[d+2]);for(M in J){g=J[M];r=new pc.IndexBuffer(a,m.format,g.length,m.usage);(new Uint16Array(r.lock())).set(g);r.unlock();A=G=R=Number.MAX_VALUE;z=-Number.MAX_VALUE;B=-Number.MAX_VALUE;S=-Number.MAX_VALUE;for(f=0;f<g.length;f++)d=g[f],e=q[d*v+x],w=q[d*v+x+1],d=q[d*v+x+2],e<R&&(R=e),w<G&&(G=w),d<A&&(A=d),e>z&&(z=e),w>B&&(B=w),d>S&&(S=d);t.set(R,G,A);P.set(z,B,S);f=new pc.BoundingBox;
...
b.lightMapUv=1,b.lightMapTransform=0,b.lightMapWithoutAmbient=!0,b.useRgbm=!0,0!==(c&pc.SHADERDEF_DIRLM)&&(b.dirLightMap=!0)),g=0!==(c&pc.SHADERDEF_UV0),h=0!==(c&pc.SHADERDEF_UV1),t=0!==(c&pc.SHADERDEF_VCOLOR));for(var q in pc._matTex2D)if("opacity"!==q||this.blendType!==pc.BLEND_NONE||0!==this.alphaTest)e=q+"Map",k=e+"VertexColor","height"!==q&&this[k]?t&&(e+="Channel",b[k]=this[k],b[e]=this[e],b.vertexColors=!0):this[e]&&(k=e+"Uv",n=!0,0!==this[k]||g||(n=!1),1!==this[k]||h||(n=!1),n&&(b[e]=!!this[e],
n=e+"Transform",e+="Channel",b[n]=this._getMapTransformID(this[n],this[k]),b[e]=this[e],b[k]=this[k]));b.aoMapUv=b.aoMapUv||this.aoUvSet;this._mapXForms=null;this.useLighting?(q=[],g=c?c>>16:1,this._collectLights(pc.LIGHTTYPE_DIRECTIONAL,f,q,g),this._collectLights(pc.LIGHTTYPE_POINT,f,q,g,d),this._collectLights(pc.LIGHTTYPE_SPOT,f,q,g,d),b.lights=q):b.lights=[];this.shader=a.getProgramLibrary().getProgram("standard",b);c||(this.clearVariants(),this.variants[0]=this.shader);this.dirtyShader=!1}});
...
n=c[b].offset:c[b].name===pc.SEMANTIC_BLENDWEIGHT&&(r=c[b].offset);var c=new Uint8Array(this.mesh.vertexBuffer.storage),q=new Float32Array(this.mesh.vertexBuffer.storage);k/=4;var u=r/4,y=e/4,x,v,w,z,A;r=[];var B=[],D=this.mesh.boneUsed;for(b=0;b<a;b++)r[b]=new pc.Vec3(Number.MAX_VALUE,Number.MAX_VALUE,Number.MAX_VALUE),B[b]=new pc.Vec3(-Number.MAX_VALUE,-Number.MAX_VALUE,-Number.MAX_VALUE);for(m=0;m<d;m++)for(t=0;4>t;t++)0<q[m*y+u+t]&&(b=c[m*e+n+t],w=q[m*y+k],z=q[m*y+k+1],A=q[m*y+k+2],x=B[b],v=r[b],
v.x>w&&(v.x=w),v.y>z&&(v.y=z),v.z>A&&(v.z=A),x.x<w&&(x.x=w),x.y<z&&(x.y=z),x.z<A&&(x.z=A),D[b]=!0);for(b=0;b<a;b++)d=new pc.BoundingBox,d.setMinMax(r[b],B[b]),this.mesh.boneAabb.push(d)}if(!this._boneAabb)for(this._boneAabb=[],b=0;b<this.mesh.boneAabb.length;b++)this._boneAabb[b]=new pc.BoundingBox;D=this.mesh.boneUsed;for(b=0;b<this.mesh.boneAabb.length;b++)D[b]&&(this._boneAabb[b].setFromTransformedAabb(this.mesh.boneAabb[b],this.skinInstance.matrices[b]),this._boneAabb[b].center.add(this.skinInstance.rootNode.getPosition()));
...
return-1}};return{partitionSkin:function(d,f,g){var h,p,l,k;b(d);var n=d.vertices,r=d.skins,m,t=d.meshes,q=d.meshInstances,u=function(a){var b=new e;b.index=a;return b};for(h=r.length-1;0<=h;h--)if(r[h].boneNames.length>g){var y=r.splice(h,1)[0],x=[];for(p=0;p<t.length;p++)t[p].skin===y&&x.push(t[p]);for(p=0;p<x.length;p++)k=t.indexOf(x[p]),-1!==k&&t.splice(k,1);if(0===x.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var v=x[0].vertices;for(p=1;p<x.length;p++)if(x[p].vertices!==
v)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var w=[],z=[];l=[];var A=0;for(p=0;p<x.length;p++){m=x[p];for(var B=m.indices,D=m.base;D<m.base+m.count;){k=B[D++];z[0]=u(k);l[0]=k;k=B[D++];z[1]=u(k);l[1]=k;k=B[D++];z[2]=u(k);l[2]=k;for(var J=!1,L=A;L<w.length;L++)if(k=w[L],k.addPrimitive(z,l,v,g)){J=!0;break}J||(k=new a,k.originalMesh=m,k.addPrimitive(z,l,v,g),w.push(k))}A=w.length}m=[];x=[];for(p=0;p<w.length;p++)if(k=w[p],k.vertices.length&&
k.indices.length){z=m.length;l=k.vertices.length;A=x.length;B=k.indices.length;k.partition=p;k.vertexStart=z;k.vertexCount=l;k.indexStart=A;k.indexCount=B;D=0;for(J=z;D<l;)m[J++]=k.vertices[D++];D=0;for(J=A;D<B;)x[J++]=k.indices[D++]+z}z=[];for(p=0;p<w.length;p++){k=w[p];A=[];B=[];for(l=0;l<k.boneIndices.length;l++)A.push(y.inverseBindMatrices[k.boneIndices[l]]),B.push(y.boneNames[k.boneIndices[l]]);k={inverseBindMatrices:A,boneNames:B};z.push(k);r.push(k)}var H,y={};for(H in v)y[H]={components:v[H].components,
data:[],type:v[H].type};for(H in v)if("blendIndices"===H)for(k=y[H].data,p=0;p<m.length;p++)l=m[p].boneIndices,k.push(l[0],l[1],l[2],l[3]);else for(p=v[H],A=p.data,B=p.components,p=0;p<m.length;p++)for(k=m[p].index,l=0;l<B;l++)y[H].data.push(A[k*B+l]);n[n.indexOf(v)]=y;for(p=0;p<w.length;p++)for(k=w[p],m={aabb:{min:[0,0,0],max:[0,0,0]},vertices:y,skin:z[p],indices:x.splice(0,k.indexCount),type:"triangles",base:0,count:k.indexCount},t.push(m),l=q.length-1;0<=l;l--)q[l].mesh===k.originalMesh&&(q.push({mesh:m,
...
new Float32Array(this.vertexBuffer.lock());if(this.meshInstance.node){c=this.meshInstance.node.worldTransform;for(d=0;12>d;d++)A.data[d]=c.data[d];L=this.meshInstance.node.localScale;J=Math.max(Math.max(L.x,L.y),L.z)}d=null===this.meshInstance.node||this.localSpace?pc.Vec3.ZERO:this.meshInstance.node.getPosition();var k=this.camera?this.camera._node.getPosition():pc.Vec3.ZERO,p,l,n,r,F,O,N,P,R,W=this.precision-1;for(c=0;c<this.numParticles;c++){var I=Math.floor(this.vbCPU[c*this.numParticleVerts*
4+3]),U=this.particleTex[4*I+0+8*this.numParticlesPot];y.data[0]=U;y.data[1]=this.particleTex[4*I+1+8*this.numParticlesPot];y.data[2]=this.particleTex[4*I+2+8*this.numParticlesPot];var Y=this.rate+(this.rate2-this.rate)*U,Z=this.lifetime,V=this.particleTex[4*I+3+4*this.numParticlesPot]+a,ka=Math.max(Math.min(V/Z,1),0),ha=0,h=0,ja=0<V&&V<Z;ja?(h=ka*W,n=Math.floor(h),r=Math.ceil(h),h%=1,p=this.qRotSpeed[n],l=this.qRotSpeed[r],F=p+(l-p)*h,p=this.qRotSpeed2[n],l=this.qRotSpeed2[r],O=p+(l-p)*h,p=this.qScale[n],
l=this.qScale[r],ha=p+(l-p)*h,p=this.qScale2[n],l=this.qScale2[r],N=p+(l-p)*h,p=this.qAlpha[n],l=this.qAlpha[r],P=p+(l-p)*h,p=this.qAlpha2[n],l=this.qAlpha2[r],R=p+(l-p)*h,n*=3,r*=3,p=this.qLocalVelocity[n],l=this.qLocalVelocity[r],t.data[0]=p+(l-p)*h,p=this.qLocalVelocity[n+1],l=this.qLocalVelocity[r+1],t.data[1]=p+(l-p)*h,p=this.qLocalVelocity[n+2],l=this.qLocalVelocity[r+2],t.data[2]=p+(l-p)*h,p=this.qLocalVelocity2[n],l=this.qLocalVelocity2[r],u.data[0]=p+(l-p)*h,p=this.qLocalVelocity2[n+1],l=
this.qLocalVelocity2[r+1],u.data[1]=p+(l-p)*h,p=this.qLocalVelocity2[n+2],l=this.qLocalVelocity2[r+2],u.data[2]=p+(l-p)*h,p=this.qVelocity[n],l=this.qVelocity[r],m.data[0]=p+(l-p)*h,p=this.qVelocity[n+1],l=this.qVelocity[r+1],m.data[1]=p+(l-p)*h,p=this.qVelocity[n+2],l=this.qVelocity[r+2],m.data[2]=p+(l-p)*h,p=this.qVelocity2[n],l=this.qVelocity2[r],q.data[0]=p+(l-p)*h,p=this.qVelocity2[n+1],l=this.qVelocity2[r+1],q.data[1]=p+(l-p)*h,p=this.qVelocity2[n+2],l=this.qVelocity2[r+2],q.data[2]=p+(l-p)*
h,t.data[0]+=(u.data[0]-t.data[0])*y.data[0],t.data[1]+=(u.data[1]-t.data[1])*y.data[1],t.data[2]+=(u.data[2]-t.data[2])*y.data[2],0<this.initialVelocity&&(this.emitterShape===pc.EMITTERSHAPE_SPHERE?(K.copy(y).scale(2).sub(pc.Vec3.ONE).normalize(),t.add(K.scale(this.initialVelocity))):t.add(pc.Vec3.FORWARD.scale(this.initialVelocity))),m.data[0]+=(q.data[0]-m.data[0])*y.data[0],m.data[1]+=(q.data[1]-m.data[1])*y.data[1],m.data[2]+=(q.data[2]-m.data[2])*y.data[2],F+=(O-F)*y.data[1],ha=(ha+1E4*U%1*
(N-ha))*J,h=1E3*U%1*(R-P),this.meshInstance.node&&A.transformPoint(t,t),t.add(m.mul(L)),z.copy(t),x.data[0]=this.particleTex[4*I],x.data[1]=this.particleTex[4*I+1],x.data[2]=this.particleTex[4*I+2],v.copy(x).add(t.scale(a)),w.copy(v),this.particleTex[4*I]=w.data[0],this.particleTex[4*I+1]=w.data[1],this.particleTex[4*I+2]=w.data[2],this.particleTex[4*I+3]+=F*a,this.wrap&&this.wrapBounds&&(w.sub(d),w.data[0]=e(w.data[0],this.wrapBounds.data[0])-.5*this.wrapBounds.data[0],w.data[1]=e(w.data[1],this.wrapBounds.data[1])-
...
pc.calculateTangents=function(e,a,b,c){var d=c.length/3,f=e.length/3,g,h,p,l,k,n,r,m,t,q,u,y,x,v,w=new pc.Vec3,z=new pc.Vec3,A=new pc.Vec3,B=new pc.Vec3,D=new pc.Vec3,J=new pc.Vec2,L=new pc.Vec2,H=new pc.Vec2,K,F=new Float32Array(3*f),C=new Float32Array(3*f),O=[];for(K=0;K<d;K++)g=c[3*K],h=c[3*K+1],p=c[3*K+2],A.set(e[3*g],e[3*g+1],e[3*g+2]),B.set(e[3*h],e[3*h+1],e[3*h+2]),D.set(e[3*p],e[3*p+1],e[3*p+2]),J.set(b[2*g],b[2*g+1]),L.set(b[2*h],b[2*h+1]),H.set(b[2*p],b[2*p+1]),l=B.x-A.x,k=D.x-A.x,n=B.y-
A.y,r=D.y-A.y,m=B.z-A.z,t=D.z-A.z,q=L.x-J.x,u=H.x-J.x,y=L.y-J.y,x=H.y-J.y,v=1/(q*x-u*y),w.set((x*l-y*k)*v,(x*n-y*r)*v,(x*m-y*t)*v),z.set((q*k-u*l)*v,(q*r-u*n)*v,(q*t-u*m)*v),F[3*g+0]+=w.x,F[3*g+1]+=w.y,F[3*g+2]+=w.z,F[3*h+0]+=w.x,F[3*h+1]+=w.y,F[3*h+2]+=w.z,F[3*p+0]+=w.x,F[3*p+1]+=w.y,F[3*p+2]+=w.z,C[3*g+0]+=z.x,C[3*g+1]+=z.y,C[3*g+2]+=z.z,C[3*h+0]+=z.x,C[3*h+1]+=z.y,C[3*h+2]+=z.z,C[3*p+0]+=z.x,C[3*p+1]+=z.y,C[3*p+2]+=z.z;y=new pc.Vec3;x=new pc.Vec3;e=new pc.Vec3;b=new pc.Vec3;for(K=0;K<f;K++)e.set(a[3*
K],a[3*K+1],a[3*K+2]),y.set(F[3*K],F[3*K+1],F[3*K+2]),x.set(C[3*K],C[3*K+1],C[3*K+2]),c=e.dot(y),b.copy(e).scale(c),b.sub2(y,b).normalize(),O[4*K]=b.x,O[4*K+1]=b.y,O[4*K+2]=b.z,b.cross(e,y),O[4*K+3]=0>b.dot(x)?-1:1;return O};
...
pc.createTorus=function(e,a){var b=a&&void 0!==a.tubeRadius?a.tubeRadius:.2,c=a&&void 0!==a.ringRadius?a.ringRadius:.3,d=a&&void 0!==a.segments?a.segments:30,f=a&&void 0!==a.sides?a.sides:20,g,h,p,l,k,n,r,m,t,q,u=[],y=[],x=[],v=[];for(g=0;g<=f;g++)for(h=0;h<=d;h++)p=Math.cos(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),l=Math.sin(2*Math.PI*g/f)*b,k=Math.sin(2*Math.PI*h/d)*(c+b*Math.cos(2*Math.PI*g/f)),n=Math.cos(2*Math.PI*h/d)*Math.cos(2*Math.PI*g/f),r=Math.sin(2*Math.PI*g/f),m=Math.sin(2*Math.PI*
h/d)*Math.cos(2*Math.PI*g/f),t=g/f,q=1-h/d,u.push(p,l,k),y.push(n,r,m),x.push(t,q),g<f&&h<d&&(p=g*(d+1)+h,l=(g+1)*(d+1)+h,k=g*(d+1)+(h+1),n=(g+1)*(d+1)+(h+1),v.push(p,l,k),v.push(l,n,k));b={normals:y,uvs:x,indices:v};pc.precalculatedTangents&&(b.tangents=pc.calculateTangents(u,y,x,v));return pc.createMesh(e,u,b)};
pc._createConeData=function(e,a,b,c,d,f){var g,h,p,l,k,n=new pc.Vec3,r=new pc.Vec3;p=new pc.Vec3;var m,t=[],q=[],u=[],y=[],x=[],v;if(0<b)for(g=0;g<=c;g++)for(h=0;h<=d;h++)v=h/d*2*Math.PI-Math.PI,m=Math.sin(v),v=Math.cos(v),k=new pc.Vec3(m*e,-b/2,v*e),l=new pc.Vec3(m*a,b/2,v*a),n.lerp(k,l,g/c),r.sub2(l,k).normalize(),m=new pc.Vec3(v,0,-m),p.cross(m,r).normalize(),t.push(n.x,n.y,n.z),q.push(p.x,p.y,p.z),l=h/d,k=g/c,u.push(l,k),m=k,k=l,l=m,l/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+
primitiveUv1Padding,y.push(l,k),g<c&&h<d&&(m=g*(d+1)+h,v=g*(d+1)+(h+1),l=(g+1)*(d+1)+h,k=(g+1)*(d+1)+(h+1),x.push(m,v,l),x.push(v,k,l));if(f){e=Math.floor(d/2);g=b/2;for(b=0;b<=e;b++)for(v=b*Math.PI*.5/e,m=Math.sin(v),v=Math.cos(v),n=0;n<=d;n++)f=2*n*Math.PI/d-Math.PI/2,l=Math.sin(f),f=Math.cos(f),f*=m,h=v,p=l*m,l=1-n/d,k=1-b/e,t.push(f*a,h*a+g,p*a),q.push(f,h,p),u.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=1/3,y.push(l,
k);r=(c+1)*(d+1);for(b=0;b<e;++b)for(n=0;n<d;++n)m=b*(d+1)+n,v=m+d+1,x.push(r+m+1,r+v,r+m),x.push(r+m+1,r+v+1,r+v);for(b=0;b<=e;b++)for(v=.5*Math.PI+b*Math.PI*.5/e,m=Math.sin(v),v=Math.cos(v),n=0;n<=d;n++)f=2*n*Math.PI/d-Math.PI/2,l=Math.sin(f),f=Math.cos(f),f*=m,h=v,p=l*m,l=1-n/d,k=1-b/e,t.push(f*a,h*a-g,p*a),q.push(f,h,p),u.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=2/3,y.push(l,k);r=(c+1)*(d+1)+(d+1)*(e+1);for(b=0;b<
e;++b)for(n=0;n<d;++n)m=b*(d+1)+n,v=m+d+1,x.push(r+m+1,r+v,r+m),x.push(r+m+1,r+v+1,r+v)}else{r=(c+1)*(d+1);if(0<e)for(g=0;g<d;g++)v=g/d*2*Math.PI,f=Math.sin(v),h=-b/2,p=Math.cos(v),l=1-(f+1)/2,k=(p+1)/2,t.push(f*e,h,p*e),q.push(0,-1,0),u.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=1/3,y.push(l,k),1<g&&x.push(r,r+g,r+g-1);r+=d;if(0<a)for(g=0;g<d;g++)v=g/d*2*Math.PI,f=Math.sin(v),h=b/2,p=Math.cos(v),l=1-(f+1)/2,k=(p+1)/2,t.push(f*
a,h,p*a),q.push(0,1,0),u.push(l,k),l/=3,k/=3,l=l*primitiveUv1PaddingScale+primitiveUv1Padding,k=k*primitiveUv1PaddingScale+primitiveUv1Padding,l+=2/3,y.push(l,k),1<g&&x.push(r,r+g-1,r+g)}return{positions:t,normals:q,uvs:u,uvs1:y,indices:x}};
...
pc.createSphere=function(e,a){var b=a&&void 0!==a.radius?a.radius:.5,c=a&&void 0!==a.latitudeBands?a.latitudeBands:16,d=a&&void 0!==a.longitudeBands?a.longitudeBands:16,f,g,h,p,l,k,n,r,m,t=[],q=[],u=[],y=[];for(g=0;g<=c;g++)for(f=g*Math.PI/c,h=Math.sin(f),p=Math.cos(f),f=0;f<=d;f++)l=2*f*Math.PI/d-Math.PI/2,k=Math.sin(l),l=Math.cos(l),l*=h,n=p,k*=h,r=1-f/d,m=1-g/c,t.push(l*b,n*b,k*b),q.push(l,n,k),u.push(r,m);for(g=0;g<c;++g)for(f=0;f<d;++f)b=g*(d+1)+f,h=b+d+1,y.push(b+1,h,b),y.push(b+1,h+1,h);c=
{normals:q,uvs:u,uvs1:u,indices:y};pc.precalculatedTangents&&(c.tangents=pc.calculateTangents(t,q,u,y));return pc.createMesh(e,t,c)};
...
d=new Ammo.btCompoundShape,e,f;for(e=0;e<c.meshInstances.length;e++){var g=c.meshInstances[e],h=g.mesh,p=h.indexBuffer[pc.RENDERSTYLE_SOLID],u=h.vertexBuffer,y=u.getFormat(),x=y.size/4,v;for(f=0;f<y.elements.length;f++){var w=y.elements[f];w.name===pc.SEMANTIC_POSITION&&(v=new Float32Array(u.lock(),w.offset))}var p=new Uint16Array(p.lock()),u=h.primitive[0].count/3,y=new Ammo.btVector3,w=new Ammo.btVector3,z=new Ammo.btVector3,A,B,D=h.primitive[0].base,J=new Ammo.btTriangleMesh;for(f=0;f<u;f++)h=
p[D+3*f]*x,A=p[D+3*f+1]*x,B=p[D+3*f+2]*x,y.setValue(v[h],v[h+1],v[h+2]),w.setValue(v[A],v[A+1],v[A+2]),z.setValue(v[B],v[B+1],v[B+2]),J.addTriangle(y,w,z,!0);f=new Ammo.btBvhTriangleMeshShape(J,!0);x=g.node.getWorldTransform().getScale();f.setLocalScaling(new Ammo.btVector3(x.x,x.y,x.z));x=g.node.getPosition();g=g.node.getRotation();p=new Ammo.btTransform;p.setIdentity();p.getOrigin().setValue(x.x,x.y,x.z);x=new Ammo.btQuaternion;x.setValue(g.x,g.y,g.z,g.w);p.setRotation(x);d.addChildShape(p,f)}c=
...
d=Module._malloc(c),l=Module.HEAPU8,k,n=d/4,r=c%4,m=new Uint32Array(p.buffer,0,(c-r)/4),t=new Uint32Array(l.buffer);for(k=0;k<m.length;k++)t[n+k]=m[k];for(k=c-r;k<c;k++)l[d+k]=p[k];p=Module._crn_decompress_get_data(d,c);c=Module._crn_decompress_get_size(d,c);b=Module.HEAPU8.buffer.slice(p,p+c)}c=new Uint32Array(b,0,32);var d=c[4],p=c[3],l=Math.max(c[7],1),q=c[21],u=c[22];k=65024===c[28];var y=t=m=r=n=!1;if(4===c[20])if(827611204===q)e=pc.PIXELFORMAT_DXT1,n=!0;else if(894720068===q)e=pc.PIXELFORMAT_DXT5,
n=!0;else if(116===q)e=pc.PIXELFORMAT_RGBA32F,r=!0;else if(826496069===q)e=pc.PIXELFORMAT_ETC1,m=n=!0;else if(825438800===q||825504336===q)e=825438800===q?pc.PIXELFORMAT_PVRTC_2BPP_RGB_1:pc.PIXELFORMAT_PVRTC_2BPP_RGBA_1,t=n=!0;else{if(825439312===q||825504848===q)e=825439312===q?pc.PIXELFORMAT_PVRTC_4BPP_RGB_1:pc.PIXELFORMAT_PVRTC_4BPP_RGBA_1,y=n=!0}else 32===u&&(e=pc.PIXELFORMAT_R8_G8_B8_A8);if(!e)return c=new pc.Texture(this._device,{width:4,height:4,format:pc.PIXELFORMAT_R8_G8_B8});c=new pc.Texture(this._device,
{width:d,height:p,format:e,cubemap:k});k&&(c.addressU=pc.ADDRESS_CLAMP_TO_EDGE,c.addressV=pc.ADDRESS_CLAMP_TO_EDGE);for(var e=128,u=k?6:1,x,q=827611204===q?8:16,v,w=0;w<u;w++)for(var z=d,A=p,B=0;B<l;B++)n?m?x=Math.floor((z+3)/4)*Math.floor((A+3)/4)*8:t?x=Math.max(z,16)*Math.max(A,8)/4:y?x=Math.max(z,8)*Math.max(A,8)/2:(x=Math.floor((z+4-1)/4),v=Math.floor((A+4-1)/4),x*=v,x*=q):x=z*A*4,v=r?new Float32Array(b,e,x):new Uint8Array(b,e,x),k?(c._levels[B]||(c._levels[B]=[]),c._levels[B][w]=v):c._levels[B]=
v,e+=r?4*x:x,z=Math.max(.5*z,1),A=Math.max(.5*A,1);c.upload()}return c}},patch:function(b,d){var c=b.resource;c&&(c.name!==b.name&&(c.name=b.name),b.data.hasOwnProperty("minfilter")&&c.minFilter!==a[b.data.minfilter]&&(c.minFilter=a[b.data.minfilter]),b.data.hasOwnProperty("magfilter")&&c.magFilter!==a[b.data.magfilter]&&(c.magFilter=a[b.data.magfilter]),b.data.hasOwnProperty("addressu")&&c.addressU!==e[b.data.addressu]&&(c.addressU=e[b.data.addressu]),b.data.hasOwnProperty("addressv")&&c.addressV!==
...
(E[N]=Q[N]);v.push(E)}u.shadowCasters=v;N=[];var X=[],ba=[[],[]],ga,ca,I=[];I.length=k.length;u.updateShadersFunc(q);for(E=0;E<k.length;E++)for(M=z[E],m=0;m<M.length;m++)v=M[m].material,N.push(v);for(v=0;v<x;v++)l[v]||(m=new pc.StandardMaterial,m.chunks.transformVS=U,0===v?(m.chunks.endPS=W,m.ambient=new pc.Color(0,0,0),m.ambientTint=!0):(m.chunks.basePS=O.basePS+"\nuniform sampler2D texture_dirLightMap;\nuniform float bakeDir;\n",m.chunks.endPS=O.bakeDirLmEndPS),m.chunks.outputAlphaPS="\n",m.chunks.outputAlphaOpaquePS=
"\n",m.chunks.outputAlphaPremulPS="\n",m.cull=pc.CULLFACE_NONE,m.forceUv1=!0,m.update(),m.updateShader(q,u),l[v]=m);for(E=0;E<k.length;E++){M=z[E];I[E]=0;if(0<M.length)for(f.copy(M[0].aabb),m=0;m<M.length;m++)M[m].node.getWorldTransform(),f.add(M[m].aabb);m=new pc.BoundingBox;m.copy(f);X.push(m);for(m=0;m<M.length;m++)Q=M[m],Q._shaderDefs&=~(pc.SHADERDEF_LM|pc.SHADERDEF_DIRLM),Q.mask=4,Q.deleteParameter("texture_lightMap"),Q.deleteParameter("texture_dirLightMap"),Q.setParameter("texture_dirLightMap",
...
v&&R.setValue(B[m].bakeDir?1:0);this.renderer.render(u,c);y.shadowMapTime+=this.renderer._shadowMapTime;y.forwardTime+=this.renderer._forwardTime;y.renderPasses++;D[v][E]=ga;ba[v][E]=Q;J[O.width]=U;for(n=0;n<M.length;n++)Q=M[n],Q.setParameter(p[v],ga),Q._shaderDefs|=pc.SHADERDEF_LM}I[E]++}B[m].enabled=!1;B[m]._cacheShadowMap=!1}for(E=y=0;E<k.length;E++){M=z[E];ca=[];for(v=0;v<x;v++){O=D[v][E];U=ba[v][E];Q=J[O.width];ga=Q.colorBuffer;P.set(1/O.width,1/O.height);Y.setValue(P.data);for(m=0;4>m;m++)Z.setValue(O),
pc.drawQuadWithShader(q,Q,H),Z.setValue(ga),pc.drawQuadWithShader(q,U,H);for(m=0;m<M.length;m++)Q=M[m],0===v&&(Q.mask=2,M[m].material=N[y],y++),M[m].setParameter(p[v],O),1===v&&(M[m]._shaderDefs|=pc.SHADERDEF_DIRLM);ca[v]=O;v===x-1&&U.destroy()}a.push(ca);b.push(k[E])}for(var ia in J)J.hasOwnProperty(ia)&&(J[ia].colorBuffer.destroy(),J[ia].destroy());for(m=0;m<a.length;m++)for(n=0;n<a[m].length;n++)H=a[m][n],H.minFilter=pc.FILTER_LINEAR,H.magFilter=pc.FILTER_LINEAR;for(E=0;E<w.length;E++)w[E].model.castShadows=
